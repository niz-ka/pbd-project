...
with DAG(
    ...
    params={
        "dags_home": Param("/home/<user>/airflow/dags", type="string"),
        "input_dir": Param("gs://<bucket>/projekt1/input", type="string"),
    ...
    mapreduce_classic = BashOperator(
        ...
        bash_command="""hadoop jar {{ params.input_dir }}/project_files/transform2.jar Transform2 {{ params.input_dir }}/datasource1 {{ params.output_mr_dir }}""",
    )
